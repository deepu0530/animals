...
import 'models/pet_corner_model.dart';
...
class _CategoryState extends State<Category> {
  ...
  Widget build(BuildContext context) {
    return Container(
      //height: 50,
      width: 60,
      decoration: widget.boxposition == widget.name ?BoxDecoration( shape: BoxShape.rectangle,
        borderRadius: BorderRadius.circular(12),

        //color: Colors.red,
        color: Color(0xFF3D015B),) :BoxDecoration(
        shape: BoxShape.rectangle,
        borderRadius: BorderRadius.circular(12),
        //color: Colors.red,
    ...
    return InkWell(
      onTap: () {
        Navigator.of(context).push(
          MaterialPageRoute(
            builder: (context) => SingleAnimal(title: widget.name,),
          ),
        );
      },
      child: Container(
...
// import 'dart:convert';
//
// import 'package:animals/models/pet_corner_model.dart';
// import 'package:dio/dio.dart';
// import 'package:animals/single_animal.dart';
